...
<body>
	...
	<form id="form">
		<div class="block">
			...
			<input name="toolID" id="toolID" value="4389199" placeholder="工具ID，用不到可以不填">
		</div>
		<div class="block">
			<div class="name">帮区ID：</div>
			<%--<input name="runningBandID" value="314553415" id="runningBandID" placeholder="工具运行帮区视图ID，用不到可以不填">--%>
			<input name="runningBandID" value="7600023576" id="runningBandID" placeholder="工具运行帮区视图ID，用不到可以不填">
		</div>
		<div class="block">
			<div class="name">bandObjID：</div>
			<input name="bandObjID" id="bandObjID" value="314545060" placeholder="帮区对象ID">
		</div>
		<div class="block">
		...
		<div class="block">
			...
			<input name="userAccount" value="wangzhe" placeholder="运行工具的用户的帐号，用不到可以不填">
		</div>
		<div class="block">
			<div class="name">用户名：</div>
			<input name="userName" value="王哲" placeholder="运行工具的用户的用户名，用不到可以不填">
		</div>
		<div class="block">
			<div class="name">用户ID：</div>
			<input name="userID" value="10202046" id="userID" placeholder="运行工具的用户ID，用不到可以不填">
		</div>
		<div class="block">
			<div class="name">accessToken：</div>
			<input name="accessToken" id="accessToken" placeholder="运行工具的用户的登录令牌，用不到可以不填">
		</div>
		<div class="block">
		...
		<div class="block">
			...
			<input name="param" id="param" placeholder="工具运行参数，用不到可以不填" >
		</div>
		<div class="block">
