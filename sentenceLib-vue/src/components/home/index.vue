<template>
  <div class="total">
    <div class="nav">
      <a class="nav-content"  href="https://www.wetoband.com/web//gotoHome" target="_blank">吾托帮平台</a>
      <a class="nav-content"  href="https://www.wetoband.com/factory//gotoHome" target="_blank">开发平台</a>
     
      <sapn
        class="nav-content"
        @click="$router.push({ name: 'TalkWorkCenter' })"
        >创作中心</sapn
      >
      ...
      <span class="nav-content">
        ...
        ></a-icon>
        <a-dropdown>
          <a class="usernameLink" @click="(e) => e.preventDefault()">
            {{ userName }}<a-icon type="down" />
          </a>
          <a-menu slot="overlay">
            <a-menu-item>
              <!-- <a @click="$router.push('logout')">退出</a> -->
              <a @click="$router.push('personCenter')">个人中心</a>
              
            </a-menu-item>
           <a-menu-item> <a @click="logout()">退出</a></a-menu-item>
          </a-menu>
        </a-dropdown>
      </span>
    </div>
    ...
    <div class="content" ref="anchorContent" id="anchorContent">
      <div class="talk-nav" id="talk">
        ...
        <span 
        class="talk-nav-two more-btn"
        @click="$router.push('talkMore')"
        >更多>></span>
      </div>
      <div class="talk-content">
        <a-list item-layout="vertical" size="large" :data-source="postListData.slice(0, 2)">
          <a-list-item
            slot="renderItem"
            key="item.title"
          ...
          <!--  @mouseenter="mouseenterTalk"
            ...
            <div class="otherComment" v-show="item.showComment"><!-- item.commentList.length -->
              ...
              <div class="otherCommentContent" :style="{ display: 'flex' }">
                <a-list item-layout="horizontal" :data-source="item.commentList">
      ...
      <div class="applicase-nav" id="appcase">
        ...
        <span
          class="applicase-nav-two more-btn"
          @click="$router.push('businessTypeAppcase')"
          >更多>></span
        >
      </div>
      ...
      <div class="word-nav" id="word">
       ...
       <!--  <span class="word-nav-two more-btn" @click="$router.push('workerWordPage')"> -->
        <span class="word-nav-two more-btn" @click="$router.push('wordLib')">
          更多>></span              
        >
      ...
      <div class="sentence-nav" id="sentence">
        ...
        <span
          class="sentence-nav-two more-btn"
...
export default {
  ...
  methods: {
    toWetoBand(){
      windows.location.href="https://www.wetoband.com/web//gotoHome" ;
     // target="_blank"
    },
    getApplicationCase() {
   ...
   async handleCommentClick( postid, item) { 
    ...
    async getAllPosts() {
      ...
      // this.postListData = response.data.data.rows.post;
