        ...
        Vue.directive('movable', {
            bind: function (el, binding) {
                ...
                triggerEl.ontouchstart = triggerEl.onmousedown = (e) => {
                    ...
                    let offsetWidth = (el.offsetParent && el.offsetParent.clientWidth) || window.innerWidth;
                    let offsetHeight = (el.offsetParent && el.offsetParent.clientHeight) || window.innerHeight;
